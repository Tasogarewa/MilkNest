    ...
    public class CommentDto : IMapWith<MilkNest.Domain.Comment>
    {
        ...
        public void Mapping(Profile profile)
        {
            profile.CreateMap<MilkNest.Domain.Comment, CommentDto>()
                ...
                .ForMember(x => x.ParentCommentUserImg, opt => opt.MapFrom(src => src.ParentComment != null && src.ParentComment.User.Image != null ? src.ParentComment.User.Image.Url : null))
                ...
                .ForMember(x => x.NewsTitle, opt => opt.Ignore())
