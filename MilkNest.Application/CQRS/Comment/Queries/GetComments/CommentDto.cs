    ...
    public class CommentDto:IMapWith<MilkNest.Domain.Comment>
    {
        ...
        public void Mapping(Profile profile)
        {
            profile.CreateMap<MilkNest.Domain.Comment, CommentDto>()
                ...
                .ForMember(x => x.ReplyUserName, opt => opt.MapFrom(x => x.Replies.Select(r => r.User.UserName).ToList()))
                ...
                .ForMember(x => x.ParentCommentUserName, opt => opt.MapFrom(src => src.ParentComment != null ? src.ParentComment.User.UserName : null))
